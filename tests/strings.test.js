...
check("the Chinese search placeholder", zh.searchPlaceholder, "搜索歌曲、专辑和歌单")
...
check("en queue singular", en.inQueue(1), "1 in queue")
check("en queue plural", en.inQueue(4), "4 in queue")
check("zh queue", zh.inQueue(4), "4 首在队列")
