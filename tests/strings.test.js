...
check("the English footer GitHub", en.githubLink, "Home")
check("the Chinese update check prompt", zh.checkForUpdates, "检查更新")
check("the English in-flight notice", en.checkingUpdates, "Checking for updates…")
check("the Chinese up-to-date note", zh.upToDate, "已是最新版本")
check("the Chinese update failure note", zh.checkFailed, "检查更新失败")
